                ...
                <div className="home__container_alumno_edubit">
                    <div className="home__alumnos_edubit">
                        ...
                        <p className="home__paragraph_alumno_edubit">
                            Comencé por motivos personales,
                            ya que, en ese momento tenía ingresos que podía invertir, pero no sabía cómo.
                            Actualmente tengo una cartera de 20 clientes a los cuales asesoro de forma
                    ...
                    <div className="home__alumnos_edubit">
                        <p className="home__paragraph_alumno_edubit">
                            Tenía algún conocimiento sobre inversiones en general, pero las criptomonedas
                            eran difíciles de entender. Ahora desde mi empresa las usamos para tenerlas
                            como inversión en la cartera.
                        <br />
                            <br />
                    ...
                    <div className="home__alumnos_edubit">
                        ...
                        <p className="home__paragraph_alumno_edubit">
                            Soy parte de una empresa familiar en la cual utilizaban
                            los métodos habituales de inversión, pero no obteníamos los
                            números deseados. Desde Edubit nos ayudaron a maximizar las inversiones.
                        <br />
                            <br />
                    ...
                    <div className="home__alumnos_edubit">
                        <p className="home__paragraph_alumno_edubit">
                            Como persona inquieta e innovadora comencé a investigar sobre criptomonedas,
                            gracias al simulador pude entender conceptos de inversiones que no sabía, y
                            ahora tengo mayor respaldo financiero.
                        <br />
                            <br />
